<%-- 
    ...
    Created on : 20.03.2014, 21:38:04
    Author     : Frank Steiler <frank@steiler.eu>
    Description: This JSP can be included to within another JSP to add a navigation bar on the top of the page. Depending on the user type logged in.
               : The User type gets determined by reading the session attribute "userID".
--%>
